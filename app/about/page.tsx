  ...
  return (
    <>
      ...
      <main style={{ paddingTop: '64px' }}>
        ...
        <div style={{ textAlign: 'center', padding: '4rem 1.5rem 3rem', position: 'relative', zIndex: 1 }}>
          <div
            ...
            style={{
              ...
              background: 'radial-gradient(ellipse, rgb(var(--purple-rgb) / 0.1) 0%, transparent 72%)',
              pointerEvents: 'none',
            }}
          />
        ...
        <div style={{ height: '1px', background: 'linear-gradient(90deg, transparent, rgb(var(--purple-rgb) / 0.3), transparent)' }} />
